    ...
    $.ajax({
        ...
        success: function(epaper){
            if(epaper.length !=0){
                    ...
                    $('#insert-epaper' + epaper[0].category).append('<a href="/pdf/'+epaper[0].id+'" style="width: 180px;background-color: transparent;height: 100%;top: 0%;position: relative;overflow: hidden"><img src="/Epaper/'+epaper[0].id+'/'+epaper[0].path+'" alt="" width="90%" height="220px" style="box-shadow: 0px 0px 10px rgba(0,0,0,0.2)"><h6 style="margin-top: 5px">'+date.toString().slice(4,15)+'</h6></a>');
